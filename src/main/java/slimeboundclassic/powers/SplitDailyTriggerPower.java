...
import slimeboundclassic.monsters.AcidSlimeLDailyMod;
import slimeboundclassic.monsters.SlimeBossDailyMod;
import slimeboundclassic.monsters.SpikeSlimeLDailyMod;

public class SplitDailyTriggerPower extends AbstractPower {
    public static final String POWER_ID = "SlimeboundClassic:SplitDailyTriggerPower";
    ...
    public SplitDailyTriggerPower(AbstractMonster owner, int amount) {
        ...
        this.img = new com.badlogic.gdx.graphics.Texture(slimeboundclassic.SlimeboundMod.getResourcePath(IMG));
