...
import slimeboundclassic.cards.Hexaburn;


public class NextTurnGainDivider extends AbstractPower {
    public static final String POWER_ID = "SlimeboundClassic:NextTurnGainDivider";
    ...
    public void atStartOfTurn() {
        ...
        flash();
        AbstractCard c;
        c = CardLibrary.getCard(Hexaburn.ID).makeCopy();
