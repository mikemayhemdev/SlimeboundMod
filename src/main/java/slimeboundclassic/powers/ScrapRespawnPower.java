...
public class ScrapRespawnPower extends AbstractPower {
    public static final String POWER_ID = "SlimeboundClassic:ScrapRespawnPower";
    ...
    public void atEndOfTurn(boolean isPlayer) {
        AbstractDungeon.actionManager.addToBottom(new SlimeSpawnAction(new slimeboundclassic.orbs.ScrapOozeSlime(), false, false));
        if (this.amount == 1) {
