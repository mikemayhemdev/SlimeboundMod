...
import slimeboundclassic.vfx.FakeFlashAtkImgEffect;
import slimeboundclassic.vfx.SlimeDripsEffectPurple;


public class SlimedPower extends AbstractPower {
    public static final String POWER_ID = "SlimeboundClassic:SlimedPower";
