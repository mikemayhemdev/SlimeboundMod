...
import slimeboundclassic.vfx.*;


public class GreedOozeSlime
        extends SpawnedSlime {
    public static final String ID = "SlimeboundClassic:GreedOozeSlime";
   ...
   public Boolean stopShiny = false;
    ...
    public GreedOozeSlime() {
        ...
        super(ID, -36,new Color (1F,1F,0F/255F,100F),"images/monsters/theBottom/slimeS/skeleton.atlas","images/monsters/theBottom/slimeS/skeleton.json","idle",.85F,new Color(1F,1F,30F/255F,2F), 0, 3, true, new Color(1F,1F,30F/255F, 1), SlimeFlareEffect.OrbFlareColor.AGGRESSIVE, new Texture("SlimeboundClassicImages/orbs/4.png"), "SlimeboundClassicImages/orbs/aggressive.png");
        spawnVFX();
