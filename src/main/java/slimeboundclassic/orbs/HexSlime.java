...
public class HexSlime
    ...
    public static final String ID = "SlimeboundClassic:HexSlime";
    ...
    public HexSlime() {
        super(ID,-25,new Color (.65F,.65F,1.0F,100F),"images/monsters/theBottom/slimeM/skeleton.atlas","images/monsters/theBottom/slimeM/skeleton.json","idle",1.5F,new Color(119F/255F,119/255F,1F,2F), 0,0, false, new Color(.36F, .55F, .85F, 1), SlimeFlareEffect.OrbFlareColor.HEX, new Texture("SlimeboundClassicImages/orbs/sleep.png"), "SlimeboundClassicImages/orbs/hex.png");
