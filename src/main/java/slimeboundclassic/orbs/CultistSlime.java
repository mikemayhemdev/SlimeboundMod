package slimeboundclassic.orbs;
...
import slimeboundclassic.actions.SlimeAutoAttack;
import slimeboundclassic.vfx.SlimeFlareEffect;
import slimeboundclassic.vfx.SticksParticle;
import slimeboundclassic.vfx.SticksParticleRight;


public class CultistSlime
        extends SpawnedSlime {
    public static final String ID = "SlimeboundClassic:CultistSlime";
    ...
    public CultistSlime() {
        super(ID,-25,new Color (.55F,.55F,1.0F,100F),"images/monsters/theBottom/slimeM/skeleton.atlas","images/monsters/theBottom/slimeM/skeleton.json","idle",1.5F,new Color(81F/255F,81F/255F,1F,2F), 6,0, true, new Color(.4F, .45F, .63F, 1), SlimeFlareEffect.OrbFlareColor.CULTIST, new Texture("SlimeboundClassicImages/orbs/attackBuff.png"), "SlimeboundClassicImages/orbs/cultist.png");
        spawnVFX();
