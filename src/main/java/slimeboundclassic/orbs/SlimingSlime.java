...
public class SlimingSlime
    ...
    public static final String ID = "SlimeboundClassic:SlimingSlime";

    public SlimingSlime() {
        super(ID,-17, new Color (1.0F,.5F,1.0F,100F),"images/monsters/theBottom/slimeAltS/skeleton.atlas","images/monsters/theBottom/slimeAltS/skeleton.json","idle",.85F,new Color(224F/255F,113F/255F,224F/255F,2F),1, 2,true, new Color(.6F, .47F, .59F, 1), SlimeFlareEffect.OrbFlareColor.SLIMING, new Texture("SlimeboundClassicImages/orbs/debuff2.png"), "SlimeboundClassicImages/orbs/sliming.png");
