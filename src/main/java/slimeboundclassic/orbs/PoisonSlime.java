...
public class PoisonSlime
    ...
    public static final String ID = "SlimeboundClassic:PoisonSlime";

    public PoisonSlime() {
        this(false);
    }
    public PoisonSlime(boolean topLevelVFX) {
        super(ID, -36,new Color (.5F,1.0F,.5F,100F),"images/monsters/theBottom/slimeS/skeleton.atlas","images/monsters/theBottom/slimeS/skeleton.json","idle",.85F,new Color(0.6F,.9F,.6F,2F),2, 1,true, new Color(.58F, .81F, .35F, 1), SlimeFlareEffect.OrbFlareColor.POISON, new Texture("SlimeboundClassicImages/orbs/debuff1.png"), "SlimeboundClassicImages/orbs/poisonous.png");
