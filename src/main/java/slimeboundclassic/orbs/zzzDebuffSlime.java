...
public class zzzDebuffSlime
    ...
    public static final String ID = "SlimeboundClassic:ShieldSlime";


    public zzzDebuffSlime() {

        super(ID, -32,new Color (1.0F,1.0F,0F,100F),"images/monsters/theBottom/slimeS/skeleton.atlas","images/monsters/theBottom/slimeS/skeleton.json","idle",.85F,new Color(.5f,0.5F,0.9F,2F),2, 3,true, new Color(.4F, .4F, .8F, 1), SlimeFlareEffect.OrbFlareColor.LICKING, new Texture("SlimeboundClassicImages/orbs/attackDebuff.png"), "SlimeboundClassicImages/orbs/licking.png");
