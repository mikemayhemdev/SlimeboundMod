...
public class AttackSlime
    ...
    public static final String ID = "SlimeboundClassic:AttackSlime";

    public AttackSlime() {

        super(ID, -17,new Color (1.0F,100F/255F,100F/255F,100F),"images/monsters/theBottom/slimeAltS/skeleton.atlas","images/monsters/theBottom/slimeAltS/skeleton.json","idle",.85F,new Color(0.8F,0.25F,0.25F,2F), 4, 3, true, new Color(.45F, .58F, .58F, 1), SlimeFlareEffect.OrbFlareColor.AGGRESSIVE, new Texture("SlimeboundClassicImages/orbs/3.png"), "SlimeboundClassicImages/orbs/aggressive.png");
        spawnVFX();
