...
import slimeboundclassic.powers.StudyGuardianPower;


public class zzzStudyGuardian extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzStudyGuardian";
