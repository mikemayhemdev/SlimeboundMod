...
import slimeboundclassic.powers.NextTurnGainHyperBeam;
import slimeboundclassic.powers.NextTurnGainStrengthPower;


public class zzzPrepareBeam extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzPrepareBeam";
