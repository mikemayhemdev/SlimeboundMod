...
public class SplitCultist extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:SplitCultist";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new SlimeSpawnAction(new slimeboundclassic.orbs.CultistSlime(), false, true,bonus,0));
