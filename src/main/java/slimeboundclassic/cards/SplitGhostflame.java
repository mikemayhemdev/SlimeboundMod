...
public class SplitGhostflame extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:SplitGhostflame";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new SlimeSpawnAction(new slimeboundclassic.orbs.HexSlime(), false, true));
