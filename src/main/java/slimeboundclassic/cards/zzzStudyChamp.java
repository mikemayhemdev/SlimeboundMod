...
import slimeboundclassic.powers.StudyChampPower;


public class zzzStudyChamp extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzStudyChamp";

    private static final CardStrings cardStrings;
    public static final String NAME;
    public static final String DESCRIPTION;
    public static String UPGRADED_DESCRIPTION;
    public static final String IMG_PATH = "cards/studychamp.png";
