...
import slimeboundclassic.powers.StudyAutomatonPower;


public class zzzStudyAutomaton extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzStudyAutomaton";

    private static final CardStrings cardStrings;
    public static final String NAME;
    public static final String DESCRIPTION;
    public static String UPGRADED_DESCRIPTION;
    public static final String IMG_PATH = "cards/studyautomaton.png";
