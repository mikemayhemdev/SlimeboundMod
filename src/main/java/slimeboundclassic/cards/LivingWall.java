...
import slimeboundclassic.powers.SlimedThornsPower;
import slimeboundclassic.vfx.FakeFlashAtkImgEffect;
import slimeboundclassic.vfx.SlimeDripsEffectPurple;
import slimeboundclassic.vfx.SlimeProjectileEffect;


public class LivingWall extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:LivingWall";
