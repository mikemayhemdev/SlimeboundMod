...
import slimeboundclassic.powers.DuplicatedFormEnergyPower;
import slimeboundclassic.powers.DuplicatedFormNoHealPower;
import slimeboundclassic.powers.DuplicatedFormPower;
import slimeboundclassic.powers.FirmFortitudePower;
import slimeboundclassic.vfx.SlimeDripsEffect;


public class DuplicatedForm extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:DuplicatedForm";
