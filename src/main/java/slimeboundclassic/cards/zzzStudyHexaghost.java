...
import slimeboundclassic.powers.StudyHexaghostPower;


public class zzzStudyHexaghost extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzStudyHexaghost";
