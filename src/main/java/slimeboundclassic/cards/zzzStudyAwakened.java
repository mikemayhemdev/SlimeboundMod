...
import slimeboundclassic.powers.StudyAwakenedPower;


public class zzzStudyAwakened extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:zzzStudyAwakened";
