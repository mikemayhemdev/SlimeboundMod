...
public class Defend_Slimebound extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:Defend_Slimebound";
    ...
    public Defend_Slimebound() {
        super(ID, NAME, slimeboundclassic.SlimeboundMod.getResourcePath(IMG_PATH), COST, DESCRIPTION, TYPE, AbstractCardEnum.SLIMEBOUND, RARITY, TARGET);
