...
public class SplitAcid extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:SplitAcid";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new SlimeSpawnAction(new slimeboundclassic.orbs.PoisonSlime(), false, true, 0, bonus));
