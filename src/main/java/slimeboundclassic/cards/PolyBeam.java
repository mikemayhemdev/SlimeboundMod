...
import slimeboundclassic.powers.PolyBeamAgainPower;
import slimeboundclassic.powers.PolyBeamAgainPowerUpgraded;


public class PolyBeam extends AbstractSlimeboundCard {
    public static final String ID = "SlimeboundClassic:PolyBeam";
