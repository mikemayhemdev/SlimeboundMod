...
/* 23 */     this.targetX = (targetX + com.badlogic.gdx.math.MathUtils.random(-20.0F, 20.0F) * com.megacrit.cardcrawl.core.Settings.scale);
/* 24 */     this.targetY = (targetY + com.badlogic.gdx.math.MathUtils.random(-20.0F, 20.0F) * com.megacrit.cardcrawl.core.Settings.scale);
/* 25 */     this.x = startX;
/* 26 */     this.y = startY;
/*    */   }
/*    */   
...
/*    */     
/* 33 */
/* 36 */       AbstractDungeon.effectsQueue.add(new LightFlareParticleEffect(this.x, this.y, com.badlogic.gdx.graphics.Color.CHARTREUSE));
/* 37 */       AbstractDungeon.effectsQueue.add(new com.megacrit.cardcrawl.vfx.FireBurstParticleEffect(this.x, this.y));
/*    */
/*    */     
/* 40 */     this.duration -= com.badlogic.gdx.Gdx.graphics.getDeltaTime();
/* 41 */     if (this.duration < 0.0F) {
/* 42 */       this.isDone = true;
/* 43 */       AbstractDungeon.effectsQueue.add(new GhostIgniteEffect(this.x, this.y));
/* 44 */       AbstractDungeon.effectsQueue.add(new com.megacrit.cardcrawl.vfx.GhostlyWeakFireEffect(this.x, this.y));
/*    */     }
/*    */   }
/*    */   
