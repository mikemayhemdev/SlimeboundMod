...
import slimeboundclassic.dailymods.AllSplit;
...
import slimeboundclassic.helpers.PoisonVariable;
import slimeboundclassic.helpers.SelfDamageVariable;
import slimeboundclassic.helpers.SlimedVariable;
...
import slimeboundclassic.potions.SlimedPotion;
import slimeboundclassic.potions.SlimyTonguePotion;
import slimeboundclassic.potions.SpawnSlimePotion;
import slimeboundclassic.potions.ThreeZeroPotion;
import slimeboundclassic.powers.AcidTonguePowerUpgraded;
import slimeboundclassic.powers.TackleSelfDamagePreventPower;
import slimeboundclassic.relics.*;
...
public class SlimeboundMod implements OnCardUseSubscriber, SetUnlocksSubscriber, AddCustomModeModsSubscriber, PostDungeonInitializeSubscriber, PostBattleSubscriber, PostInitializeSubscriber, PreMonsterTurnSubscriber, basemod.interfaces.EditCharactersSubscriber, basemod.interfaces.EditRelicsSubscriber, basemod.interfaces.EditCardsSubscriber, basemod.interfaces.EditKeywordsSubscriber, EditStringsSubscriber, basemod.interfaces.PostDrawSubscriber,  basemod.interfaces.OnStartBattleSubscriber {
    ...
    private static final String SLIMEBOUNDMOD_ASSETS_FOLDER = "SlimeboundClassicImages";
    ...
    public static final String getResourcePath(String resource) {
        return "SlimeboundClassicImages/" + resource;
    }
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new slimeboundclassic.cards.Defend_Slimebound());
        BaseMod.addCard(new slimeboundclassic.cards.Strike_Slimebound());
        ...
        //BaseMod.addCard(new slimeboundclassic.cards.zzzAbsorbAll());
        BaseMod.addCard(new Overexert());
        BaseMod.addCard(new Split());
        BaseMod.addCard(new SuperSplit());
        BaseMod.addCard(new LeadByExample());
        BaseMod.addCard(new slimeboundclassic.cards.SlimeTap());
        BaseMod.addCard(new Teamwork());
        BaseMod.addCard(new slimeboundclassic.cards.SlimeBarrage());
        BaseMod.addCard(new SlimeBrawl());
        //BaseMod.addCard(new slimeboundclassic.cards.zzzMaxSlimes());
        ...
        BaseMod.addCard(new slimeboundclassic.cards.Dissolve());
        BaseMod.addCard(new slimeboundclassic.cards.DuplicatedForm());
        BaseMod.addCard(new slimeboundclassic.cards.LeechingTouch());
        BaseMod.addCard(new SamplingLick());
        BaseMod.addCard(new FormOfPuddle());
        BaseMod.addCard(new slimeboundclassic.cards.Lick());
        BaseMod.addCard(new slimeboundclassic.cards.MegaLick());

        BaseMod.addCard(new PressTheAttack());
        BaseMod.addCard(new SoulSicken());
        // BaseMod.addCard(new slimeboundclassic.cards.zzzFocusedLick());
        BaseMod.addCard(new HauntingLick());
        BaseMod.addCard(new AcidGelatin());
        BaseMod.addCard(new RejuvenatingLick());
        BaseMod.addCard(new slimeboundclassic.cards.TongueLash());
        BaseMod.addCard(new ItLooksTasty());
        BaseMod.addCard(new slimeboundclassic.cards.AcidTongue());
        BaseMod.addCard(new slimeboundclassic.cards.TendrilStrike());
        BaseMod.addCard(new slimeboundclassic.cards.PoisonLick());
        BaseMod.addCard(new slimeboundclassic.cards.WasteNot());
        BaseMod.addCard(new HungryTackle());
        BaseMod.addCard(new slimeboundclassic.cards.FlameTackle());
        ...
        BaseMod.addCard(new slimeboundclassic.cards.Grow());
        BaseMod.addCard(new slimeboundclassic.cards.Prepare());
        BaseMod.addCard(new slimeboundclassic.cards.Gluttony());
        BaseMod.addCard(new slimeboundclassic.cards.UsefulSlime());
        BaseMod.addCard(new RainOfGoop());
        BaseMod.addCard(new slimeboundclassic.cards.GoopSpray());
        BaseMod.addCard(new slimeboundclassic.cards.MassFeed());
        BaseMod.addCard(new ViciousTackle());
        BaseMod.addCard(new slimeboundclassic.cards.LeechEnergy());
        BaseMod.addCard(new LeechLife());
        BaseMod.addCard(new Equalize());

        BaseMod.addCard(new DisruptingSlam());
        BaseMod.addCard(new slimeboundclassic.cards.ChargeUp());
        BaseMod.addCard(new slimeboundclassic.cards.GuardianWhirl());
        BaseMod.addCard(new slimeboundclassic.cards.CorrosiveSpit());
        BaseMod.addCard(new slimeboundclassic.cards.DefensiveMode());
        BaseMod.addCard(new PrepareCrush());
        BaseMod.addCard(new slimeboundclassic.cards.SlimeCrush());
        BaseMod.addCard(new SplitGhostflame());

        BaseMod.addCard(new Hexaburn());
        BaseMod.addCard(new slimeboundclassic.cards.Sear());

        BaseMod.addCard(new SlimeBeam());
        BaseMod.addCard(new slimeboundclassic.cards.Flail());
        BaseMod.addCard(new slimeboundclassic.cards.DefensiveStance());
        BaseMod.addCard(new slimeboundclassic.cards.FaceSlap());
        BaseMod.addCard(new slimeboundclassic.cards.Tackle());
        BaseMod.addCard(new slimeboundclassic.cards.LastStand());
        BaseMod.addCard(new slimeboundclassic.cards.Collect());
        BaseMod.addCard(new slimeboundclassic.cards.YouAreMine());
        BaseMod.addCard(new CaCaw());
        BaseMod.addCard(new slimeboundclassic.cards.DarkVoid());
        //BaseMod.addCard(new zzzSlimepotheosis());
        BaseMod.addCard(new slimeboundclassic.cards.FinishingTackle());
        ...
        BaseMod.addCard(new slimeboundclassic.cards.HeadSlam());
        BaseMod.addCard(new ManipulateTime());
        BaseMod.addCard(new DonusPower());
        BaseMod.addCard(new DecasProtection());
        BaseMod.addCard(new slimeboundclassic.cards.PolyBeam());
        BaseMod.addCard(new Repurpose());
        BaseMod.addCard(new GrowthPunch());
        BaseMod.addCard(new slimeboundclassic.cards.Recycling());
        BaseMod.addCard(new slimeboundclassic.cards.Recollect());
        BaseMod.addCard(new slimeboundclassic.cards.Icky());
