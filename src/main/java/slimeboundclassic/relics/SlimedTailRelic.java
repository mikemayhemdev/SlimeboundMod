...
public class SlimedTailRelic extends CustomRelic {
    public static final String ID = "SlimeboundClassic:SlimedTailRelic";
    ...
    public void activate(){
        ...
        AbstractDungeon.actionManager.addToTop(new SlimeSpawnAction(new slimeboundclassic.orbs.PoisonSlime(true), false, false));
        ...
        this.img = ImageMaster.loadImage("SlimeboundClassicImages/relics/slimedTailUsed.png");
    ...
    public void onVictory() {
        if (!isActive) {
            this.img = ImageMaster.loadImage("SlimeboundClassicImages/relics/slimedTail.png");
