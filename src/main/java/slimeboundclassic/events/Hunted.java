...
public class Hunted extends MindBloom {
    public static final String ID = "SlimeboundClassic:Hunted";
    ...
    public Hunted() {
        ...
        this.title = NAME;
        this.body = DIALOG_1;
        this.imageEventText.loadImage("SlimeboundClassicImages/events/hunted.jpg");
    ...
    static {
        eventStrings = CardCrawlGame.languagePack.getEventString("SlimeboundClassic:Hunted");
