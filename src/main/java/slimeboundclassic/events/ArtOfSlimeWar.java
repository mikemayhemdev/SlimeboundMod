...
package slimeboundclassic.events;
...
import slimeboundclassic.cards.CheckThePlaybook;
import slimeboundclassic.cards.Icky;
import slimeboundclassic.cards.Tackle;

import java.util.Iterator;

public class ArtOfSlimeWar extends AbstractImageEvent {
    public static final String ID = "SlimeboundClassic:ArtOfSlimeWar";
    ...
    public ArtOfSlimeWar() {
        super(NAME, DIALOG_START, "SlimeboundClassicImages/events/slimeTome.jpg");
        this.imageEventText.setDialogOption(OPTIONS[0], CardLibrary.getCopy("SlimeboundClassic:Tackle",1,0));
        this.imageEventText.setDialogOption(OPTIONS[1], CardLibrary.getCopy("SlimeboundClassic:CheckThePlaybook"));
            ...
            case 0:
                switch(buttonPressed) {
                    case 1:
                        ...
                        this.screenNum = 1;
                        this.imageEventText.updateDialogOption(0, OPTIONS[3], CardLibrary.getCopy("SlimeboundClassic:Icky"));
    ...
    static {
        eventStrings = CardCrawlGame.languagePack.getEventString("SlimeboundClassic:ArtOfSlimeWar");
