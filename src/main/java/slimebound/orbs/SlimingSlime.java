...
import slimebound.vfx.SlimeFlareEffect;
   ...
   extends SpawnedSlime
 {
   public SlimingSlime()
   {
     super("SlimingSlime", 3, true, new Color(.6F,.47F,.59F,1),SlimeFlareEffect.OrbFlareColor.SLIMING,new Texture("SlimeboundImages/orbs/debuff2.png"),"SlimeboundImages/orbs/sliming.png");
            }
