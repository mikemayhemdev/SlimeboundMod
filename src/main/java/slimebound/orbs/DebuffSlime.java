...
public class DebuffSlime
    ...
    public DebuffSlime() {
        ...
        super(ID, 2, 3,true, new Color(.83F, .83F, .39F, 1), SlimeFlareEffect.OrbFlareColor.LICKING, new Texture("SlimeboundImages/orbs/attackDebuff.png"), "SlimeboundImages/orbs/licking.png");
    }
