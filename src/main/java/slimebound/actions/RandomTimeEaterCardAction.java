...
/*    */ public class RandomTimeEaterCardAction extends AbstractGameAction {
    ...
    /*    */ {
        ...
        switch(chosenRand){
            case 1: c = CardLibrary.getCard("Ripple").makeCopy(); break;
            case 2: c = CardLibrary.getCard("StopTime").makeCopy(); break;
            case 3: c = CardLibrary.getCard("HeadSlam").makeCopy(); break;
        }
