...
/*    */ public class RandomGuardianCardAction extends AbstractGameAction {
    ...
    /*    */ {
        ...
        switch(chosenRand){
            case 1: c = CardLibrary.getCard("ChargeUp").makeCopy(); break;
            case 2: c = CardLibrary.getCard("DefensiveMode").makeCopy(); break;
            case 3: c = CardLibrary.getCard("GuardianWhirl").makeCopy(); break;
        }
