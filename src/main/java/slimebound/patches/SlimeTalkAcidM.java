...
@SpirePatch(cls="com.megacrit.cardcrawl.monsters.exordium.AcidSlime_M",method="takeTurn")
public class SlimeTalkAcidM {
    ...
    public static void Prefix(AcidSlime_M sb) {
        if (AbstractDungeon.player instanceof SlimeboundCharacter && SlimeboundMod.slimeTalkedAcidM == false) {
            AbstractDungeon.actionManager.addToBottom(new TalkAction(sb, "~It~ ~cannot~ ~leave...~", 1.0F, 2.0F));
