...
/*  39 */     this.color = new Color(0.65F,0.2F,0.65F,1F);
/*     */   }
/*     */   
/*     */   public void update() {
...
/*  51 */           com.megacrit.cardcrawl.dungeons.AbstractDungeon.effectsQueue.add(new SlimeDeathParticleEffect(this.x, this.y,new Color(0.65F,0.2F,0.65F,1F)));
/*     */         }
/*     */       }
/*     */       
/*  55 */       if (this.frame > 5) {
