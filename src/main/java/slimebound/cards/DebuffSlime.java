...
/*    */
/*    */ public class DebuffSlime extends CustomCard
        /*    */ {
    ...
    /*    */   {
        ...
        if (this.upgraded) { AbstractDungeon.actionManager.addToBottom(new SlimeSpawnAction(new slimebound.orbs.DebuffSlime(),false,true));}
        /* 35 */     }
    /*    */
    static {
