...
public class PolyBeamAgainPowerUpgraded extends AbstractPower {
    ...
    public PolyBeamAgainPowerUpgraded(AbstractCreature owner, AbstractCreature source, int amount, AbstractCard card) {
    ...
    tmp.purgeOnUse = true;
        ...
        if (this.amount <= 1) {
            ...
            AbstractDungeon.actionManager.addToBottom(new com.megacrit.cardcrawl.actions.common.RemoveSpecificPowerAction(this.owner, this.owner, "Slimebound:PolyBeamAgainPower"));

        } else {

            AbstractDungeon.actionManager.addToBottom(new com.megacrit.cardcrawl.actions.common.ReducePowerAction(this.owner, this.owner, "Slimebound:PolyBeamAgainPower", 1));
